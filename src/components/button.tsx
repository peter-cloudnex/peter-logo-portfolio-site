...
const BASE =
  "inline-flex cursor-pointer items-center justify-center rounded-md px-4 py-2 text-body font-medium no-underline transition-colors duration-150 ease-out";
